        ...
        pub mod sdk {
            ...
            pub fn verify_quote(
                ...
                unsafe {
                    ...
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
                    let vec0 = current_time;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    let vec1 = binary_quote;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let ptr2 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x98\x12\x01A\x02\x01\
...
\0\x09get-quote\x01(\x01@\x02\x0ccurrent-times\x0cbinary-quote\x05\0\x03\x04\0\x0c\
verify-quote\x01)\x01@\x03\x05inputs\x08encodingz\x06targetz\0\x08\x04\0\x0agrap\
h-load\x01*\x01@\x01\x05inputs\0\x08\x04\0\x12graph-load-by-name\x01+\x04\0\x1cg\
raph-init-execution-context\x01+\x01@\x02\x05inputs\x0cinput-tensors\0\x03\x04\0\
\x11inference-compute\x01,\x01@\0\x01\0\x04\0\x0fstart-recording\x01-\x04\0\x0es\
