...
pub mod klave {
    ...
    pub mod sdk {
        ...
        pub mod sdk {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn get_public_key_as_cryptokey(key_name: &str) -> Result<_rt::String, _rt::String> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:klave-sdk:encoded world"]
#[doc(hidden)]
...
ansaction\x01(\x03\x01\x0dklave:sdk/sdk\x05\0\x04\x01\x1dcomponent:klave-sdk/kla\
ve-sdk\x04\0\x0b\x0f\x01\0\x09klave-sdk\x03\0\0\0G\x09producers\x01\x0cprocessed\
