    ...
    return (
        <footer className="border-t border-border">
            ...
            <div className="border-t border-border">
                {/* Bottom area */}
                <div className="md:flex md:items-center md:justify-between py-4 md:py-8 max-w-6xl mx-auto px-4 sm:px-6">

                    {/* Social links */}
                    <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li>
                            <a href="https://twitter.com/klavenetwork" target='_blank' rel="noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" aria-label="Twitter">
                        ...
                        <li className="ml-4">
                            <a href="https://github.com/klave-network" target='_blank' rel="noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" aria-label="Github">
                                <svg className="w-12 h-12 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
