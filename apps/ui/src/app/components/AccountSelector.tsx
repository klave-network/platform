                ...
                <Select.Viewport>
                    {personals.length > 0
                        ? <Select.Group>
                            ...
                            {personals.map(o => <SelectItem key={o.id} value={o.slug} className="px-3 py-2 hover:text-klave-cyan hover:cursor-pointer">{o.slug} <span className='text-slate-400'>- {o.name}</span></SelectItem>)}
                        </Select.Group>
                        : null}
