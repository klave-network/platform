...
export const OrgNew: FC = () => {
    ...
    const { data: alreadyExists, isLoading: isOrgLoading } = api.v0.organisations.exists.useQuery({ orgSlug });
    ...
    return <> <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
