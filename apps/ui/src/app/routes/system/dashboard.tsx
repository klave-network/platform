...
export const SysDashboard: FC = () => {
    ...
    return <div className="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 flex-grow flex overflow-hidden text-sm">
        {/*
        <div className="bg-white dark:bg-gray-900 dark:border-gray-800 w-20 flex-shrink-0 border-r border-border flex-col hidden sm:flex">
        ...
        <div className="flex-grow overflow-hidden h-full flex flex-col">
            <div className="flex-grow flex overflow-x-hidden">
                <div className="w-72 flex-shrink-0 border-r border-border h-full min-h-[50vh] overflow-y-auto sm:block hidden p-5">
