...
export const Deployments: FC = () => {
    ...
    return <>
        <div className="hidden w-full items-center mb-7">
            <button className="btn btn-sm inline-flex mr-3 items-center h-8 pl-2.5 pr-2 rounded-md shadow dark:text-slate-400 dark:bg-slate-800 text-gray-700 dark:border-gray-800 border border-border leading-none py-0">
        ...
        <table className="w-full text-left">
            <thead>
                <tr className="text-gray-400">
                    ...
                    <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Address</th>
                    {/* <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Type</th> */}
                    {/* <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Status</th> */}
                    {/* <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Version</th> */}
                    <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Version</th>
                    <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Branch</th>
                    <th className="font-normal px-3 pt-0 pb-3 border-b border-border hidden md:table-cell">Dates</th>
                    {/* <th className="font-normal px-3 pt-0 pb-3 border-b border-border hidden md:table-cell">Created</th> */}
                    {/* <th className="font-normal px-3 pt-0 pb-3 border-b border-border">Expires</th> */}
            ...
            <tbody className="text-gray-600 dark:text-gray-100">
                {deploymentSets.map(({ deployments, earliestCreation: setCreation }) => {
                    ...
                    const isDeploying = deployments.some(({ status }) => ['created', 'deploying', 'terminating'].includes(status));
                    return <tr key={setId} className={isDeploying ? 'stripe-progress' : ''}>
                        <td className={'sm:p-3 py-2 px-1 border-b border-border grid'}>
                        ...
                        <td className="sm:p-3 py-2 px-1 align-top border-b border-border md:table-cell hidden">
                        ...
                        {/*
                                ...
                                <td className="sm:p-3 py-2 px-1 border-b border-border">
                                    <div className="flex items-center">
                                        <div className="sm:flex hidden flex-col" title={createdAt.toDateString()}>
                        ...
                        {deployments.map(deployment => {
                            ...
                            return <tr key={id} className={['created', 'compiling', 'deploying', 'terminating'].includes(status) ? 'stripe-progress' : 'hover:bg-slate-50 hover:cursor-pointer'} onClick={() => navigate(`./${id}`)}>
                                ...
                                */}
                                ...
                                {/* <td className="sm:p-3 py-2 px-1 border-b border-border">{life === 'long' ? 'prod' : 'dev'}</td> */}
                                {/* <td className={'sm:p-3 py-2 px-1 border-b border-border'}>{status}</td> */}
                                {/* <td className={'sm:p-3 py-2 px-1 border-b border-border'}><span className='font-mono rounded bg-slate-100 px-2 py-1 whitespace-nowrap'>1.0.3</span></td> */}
                                <td className="sm:p-3 py-2 px-1 border-b border-border md:table-cell hidden">
                                    <div className="flex items-center">
                                        <div className="sm:flex hidden flex-col">
