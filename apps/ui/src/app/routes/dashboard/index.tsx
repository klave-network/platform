...
export const Dashboard: FC = () => {
    ...
    return <div className="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 flex-grow flex overflow-hidden text-sm border-t border-gray-200 dark:border-gray-800">
        {/*
        <div className="bg-white dark:bg-gray-900 dark:border-gray-800 w-20 shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
            <div className="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-4">
                <button className="btn btn-md h-8 h-10 w-12 dark:bg-gray-700 dark:text-white rounded-md flex items-center justify-center bg-blue-100 text-blue-500">
