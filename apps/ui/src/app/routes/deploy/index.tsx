...
export const Index: FC = () => {
    ...
    githubAuth.searchParams.append('redirect_uri', encodeURI(process.env['KLAVE_AUTHSTATE_URL'] ?? `${window.location.origin}/auth`));
    ...
    gitlabAuth.searchParams.append('redirect_uri', encodeURI(process.env['KLAVE_AUTHSTATE_URL'] ?? `${window.location.origin}/auth`));
