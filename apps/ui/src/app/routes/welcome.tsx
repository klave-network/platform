            ...
            <div className='mx-auto w-full'>
                ...
                <Tabs.Root defaultValue="as" className='flex flex-col w-full border border-gray-200 rounded bg-slate-50 p-4'>
                    ...
                    <Tabs.Content value="as">
                        ...
                        <pre className='text-left overflow-hidden relative text-slate-500'>
                            &gt;&nbsp;&nbsp;<span className='relative'><span className='text-white before:-mx-2 before:-my-1 before:rounded before:pr-6 before:absolute before:w-[calc(100%+1rem)] before:h-8 hover:before:bg-gray-700 hover:cursor-pointer group' onClick={copyToClipboard}><span className='relative'><UilCopy className='h-4 w-4 mr-2 hidden group-hover:inline-block' />yarn create on-klave</span></span></span><br />
                        ...
                        Open your favorite IDE and check out Klave documentation to know more about the available APIs.<br />
                        ...
                        Push you newly created application repo via `git` or <a rel='noopener' title='Github CLI' target='_blank' href='https://cli.github.com/'>Github CLI</a><br />
